...
public final class HisEcgData {
  ...
  public interface HisDataECGOrBuilder extends
      // @@protoc_insertion_point(interface_extends:HisDataECG)
    ...
    /**
     * <code>repeated sfixed32 raw_data = 2 [packed = true];</code>
     */
  ...
  /**
   * Protobuf type {@code HisDataECG}
   */
  public  static final class HisDataECG extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:HisDataECG)
      HisDataECGOrBuilder {
    // Use HisDataECG.newBuilder() to construct.
    private HisDataECG(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private HisDataECG() {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 21: {
              ...
              rawData_.add(input.readSFixed32());
              break;
            }
            case 18: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HisEcgData.internal_static_HisDataECG_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HisEcgData.internal_static_HisDataECG_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HisDataECG.class, Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < rawData_.size(); i++) {
        output.writeSFixed32NoTag(rawData_.get(i));
      }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof HisDataECG)) {
        return super.equals(obj);
      }
      HisDataECG other = (HisDataECG) obj;
    ...
    public static HisDataECG parseFrom(
    ...
    public static HisDataECG parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HisDataECG parseFrom(
    ...
    public static HisDataECG parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HisDataECG parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HisDataECG parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HisDataECG prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:HisDataECG)
        HisDataECGOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HisEcgData.internal_static_HisDataECG_descriptor;
      ...
      // Construct using HisEcgData.HisDataECG.newBuilder()
      private Builder() {
      ...
      public HisDataECG getDefaultInstanceForType() {
        return HisDataECG.getDefaultInstance();
      }

      public HisDataECG build() {
        HisDataECG result = buildPartial();
      ...
      public HisDataECG buildPartial() {
        HisDataECG result = new HisDataECG(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HisDataECG) {
          return mergeFrom((HisDataECG)other);
        } else {
      ...
      public Builder mergeFrom(HisDataECG other) {
        if (other == HisDataECG.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HisDataECG parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HisDataECG) e.getUnfinishedMessage();
      ...
      // @@protoc_insertion_point(builder_scope:HisDataECG)
    }

    // @@protoc_insertion_point(class_scope:HisDataECG)
    private static final HisDataECG DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HisDataECG();
    }

    public static HisDataECG getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    @Deprecated public static final com.google.protobuf.Parser<HisDataECG>
        PARSER = new com.google.protobuf.AbstractParser<HisDataECG>() {
      public HisDataECG parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
          return new HisDataECG(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<HisDataECG> parser() {
      return PARSER;
    }

    @Override
    public com.google.protobuf.Parser<HisDataECG> getParserForType() {
      return PARSER;
    }
  ...
  private static  com.google.protobuf.Descriptors.Descriptor
    internal_static_HisDataECG_descriptor;
  private static
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_HisDataECG_fieldAccessorTable;
  ...
  static {
    String[] descriptorData = {
      "\n\022his_ecg_data.proto\032\023realtime_data.prot" +
      "o\"A\n\nHisDataECG\022\035\n\ntime_stamp\030\001 \002(\0132\t.Da" +
      "teTime\022\024\n\010raw_data\030\002 \003(\017B\002\020\001"
    };
    ...
    internal_static_HisDataECG_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HisDataECG_descriptor,
